...
<img width="200px" class="text-center rounded float-start pe-4" src="../img/projects/Constructor_and_Class.png">
<img width="200px" class="text-center rounded float-start pe-4" src="../img/projects/result.png">
<img width="200px" class="text-center rounded float-start pe-4" src="../img/projects/test_function.png">
